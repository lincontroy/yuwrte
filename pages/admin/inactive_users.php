              ...
              <div class="row">
                ...
                <div class="row">
                            ...
                            <div class="card-header bg-success">
                                <h5 class="card-title">Inactive Users' Details</h5>
                            </div>
...
?>
                          ...
                          <div class="table-responsive mb-0" data-bs-pattern="priority-columns">
                                    <table  id="tech-companies-1" class="table table-striped">
                                        ...
                                        <tbody>
               <?php
                    $pendingUsers = "SELECT * FROM `users` where active = 'inactive' ";
                                          ...
                                          <tr>
											<!--<td><img class="rounded-circle" width="35" src="images/profile/small/pic10.jpg" alt=""></td>-->
												...
												<td><?php echo $pendingUsersResultsss['phone'] ?></td>
												   <td>KSH <?php echo number_format($pendingUsersResultsss['balance']) ?></td>
		...
		?>" name="edit_balances" class="btn btn-primary shadow btn-xs sharp me-1" style="margin-top:-8px;" data-bs-toggle="modal" data-bs-target="#exampleModalCenterBal<?php echo $pendingUsersResultsss['id'];?>"><i class="fas fa-edit"></i></a>
													</div>
												</td>
                                            </tr>
