...
?> 
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">win bonuses</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      ...
      <!--    <div class="card">-->
      <!--      <div class="card-body">-->
      <!--        <h5 class="card-title">Win Bonuses</h5>-->
      <!--        <p style="color: #000000">Monetize your traffic and earn commission (Ksh 200) whenever you share Yuwrite Africa with your colleagues, after they register and activate their Accounts. </p>-->
      <!--      </div>-->
      <!--    </div>-->
      ...
      <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title"> <?php echo number_format($result['link_clicks']) ?> LINK CLICKS</h5>
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title"> <?php
                                 $email = $result['email'];
                                        $uplines = "SELECT * FROM `referals` WHERE `upline_email` = '$email'";
                                        $uplineresult = mysqli_query($conn,$uplines);
                                        if(!$uplineresult){
                                             die("error: ".mysqli_error($conn));
                                        }else{
                                             if(mysqli_num_rows($uplineresult) > 0){
                                              echo mysqli_num_rows($uplineresult);
}
else{
  echo "0";
}
...
?>  TOTAL SIGNUPS</h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title"> <?php echo number_format($result['activeInvites']) ?> ACTIVE FREELANCERS</h5>
      ...
      <div class="col-xxl-4 col-md-6">
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Affiliate Link:</h5>
            ...
            <div class="card-body">
      <?php
            $ref_url= "https://yuwriteafrica.com/register.php?upline=".$result['id'];
                        ?>

     <div class="mb-4">                    
   <input type="text"  readonly="" name="referral_link" id="copyTarget" value="<?php echo $ref_url; ?>" class="form-control bg-default" id="link"> 
  <button onclick="myFunction()" id="copyButton"  name="copyButton" type="submit" class="btn btn-primary waves-effect waves-light" style="margin-top:5px;">Copy Affiliate Link</button>
  </div>
        ...
        <div class="col-lg-8">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Withdraw Balances Here!</h5>
...
if (isset($_POST['withdraw_now'])){
    ...
    <div class="alert alert-danger text-white alert-dismissible alert-label-icon label-arrow fade show" role="alert">
                                            <i class="mdi mdi-alert-outline label-icon"></i><strong> Error !</strong> - Minimum withdrawable amount is KSH 1,000. Your account balance is Ksh <?php echo $result['ref_bal'] ?>
...
<input type="text"  disabled=""  name="bal" value="KES <?php echo $result['ref_bal'] ?>"  class="form-control bg-default"> 
